...
button10.addEventListener('click', () => {
  disp1.textContent = "added 10"
  indicator1.textContent = (parseInt(indicator.textContent) + 10).toString()
})
...
button15.addEventListener('click', () => {
  disp2.textContent = "added 15"
  indicator2.textContent = (parseInt(indicator.textContent) + 15).toString()
})
...
button20.addEventListener('click', () => {
  disp3.textContent = "added 20"
  indicator3.textContent = (parseInt(indicator.textContent) + 20).toString()
})
